    ...
    <form method="post">
        <table style="margin:auto; width:90%;">
            ...
            <tr>
            	...
            	<td style="border:1px solid;"><?php echo number_format(get_user_driver_attened_miles_YTD($user_id,(date("Y")-1)."-12-31",false,true)["Distance"],1); ?></td>
				<td style="border:1px solid;"><?php echo number_format(get_user_driver_unattened_miles_YTD($user_id,(date("Y")-1)."-12-31",false,true)["Distance"],1); ?></td>

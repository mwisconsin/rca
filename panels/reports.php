...
<table border="1" width="870px">
	...
	<tr>
		...
		<td><?php echo $links['HOSPITALCANCEL']; ?></td>
	...
	<tr>
		...
		<td><?php echo $distance['HOSPITALCANCEL']; ?></td>
	...
	<tr>
		...
		<td><?php print_division($distance['HOSPITALCANCEL'], $links['HOSPITALCANCEL'], 2); ?></td>
...
<br />
<h3>Rides by Category - Details</h3>
...
<table border="1" width="800px">
	...
	<tr>
		...
		<td><?php echo $riders['HOSPITALCANCEL']; ?></td>
	</tr>
	...
	<tr>
		...
		<td><?php echo $new_riders['HOSPITALCANCEL']; ?></td>
	</tr>
</table>
...
<table border="1" width="800px">
	...
	<tr>
		...
		<td><?php echo $drivers['HOSPITALCANCEL']; ?></td>
	</tr>
	<tr>
		<th>New Drivers</th>
		...
		<td><?php echo $new_drivers['HOSPITALCANCEL']; ?></td>
	</tr>
...
<table border="1" width="800px">
	...
	<tr>
		...
		<td><?php echo divide_items($riders['HOSPTIALCANCEL'], $drivers['HOSPTIALCANCEL']); ?></td>
	</tr>
</table>
...
<table border="1" width="800px">
	...
	?>
		...
		<td><?php echo divide_items($links['HOSPITALCANCEL'], $riders['HOSPITALCANCEL']); ?></td>
	</tr>
	<tr>
		<th>Links / Driver</th>
		...
		<td><?php echo divide_items($links['HOSPITALCANCEL'], $drivers['HOSPITALCANCEL']); ?></td>
	</tr>
</table>
...
<table border="1" width="870px">
	...
	<tr>
		...
		<td><?php printf("$%d.%02.2d", $revenue['HOSPITALCANCEL']/100, $revenue['HOSPITALCANCEL'] % 100); ?></td>
	...
	<tr>
		...
		<td><?php printf("$%d.%02.2d", $revenue['HOSPITALCANCEL']/100, $riders['HOSPITALCANCEL'] % 100); ?></td>
		<td>N/A</td>
	</tr>
	<tr>
		<th>$ / Driver</th>
		...
		<td><?php find_average_price($revenue['HOSPITALCANCEL'],$drivers['HOSPITALCANCEL']); ?></td>
		<td>N/A</td>
	</tr>
	<tr>
		<th>$ / Link</th>
		...
		<td><?php find_average_price($revenue['HOSPITALCANCEL'],$links['HOSPITALCANCEL']); ?></td>
...
<br />
<h3>Geographic Summary (by Zip)</h3>
